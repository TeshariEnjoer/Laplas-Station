	...
	<head>
		...
		<style type='text/css'>
			...
			.bg {
				...
				transform: translateY(-50%); /* Changed from translate(-50%, -50%) to translateY(-50%) */
				z-index: 0;
			}
			...
			.container_nav {
				...
				background: rgba(0, 0, 102, 0.1); /* Changed to transparent blue */
				opacity: 75%;
				padding: 1em;
			}
			...
			.menu_button {
				...
				width: 100%;
				text-align: left;
				color: white; /* Changed from #cde to white */
				height: 4vmin;
				padding-left: 5vmin;
				letter-spacing: 1px;
				cursor: pointer;
